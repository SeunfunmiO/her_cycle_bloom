...
const Navbar = () => {
    return (
        <div className='bg-white fixed bottom-0 flex items-center w-full justify-between md:gap-10 p-5'>
            ...
            <img
                style={{ left: "45%"}}
                className="bg-gray-200 md:w-20 w-12 p-2 md:p-5 rounded-full shadow-lg absolute -top-8 border-8 border-white "
                src="./WappGPT - logo.svg" alt="" />
            {/* </div> */}

            <div className="flex flex-col items-center">
                <img className='w-3 h-3 md:w-5 md:h-5' src="./Vector - 2.svg" alt="History" />
                <p className='font-bold text-xs md:text-base text-[#967682]'>History</p>
            </div>
